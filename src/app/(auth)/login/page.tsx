  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-6 py-12 overflow-hidden bg-[#030712]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -left-[10%] w-[50%] h-[50%] bg-emerald-500/10 rounded-full blur-[130px] animate-pulse" />
        <div className="absolute bottom-[10%] right-[10%] w-[40%] h-[40%] bg-teal-500/10 rounded-full blur-[110px] animate-bounce" style={{ animationDuration: '10s' }} />
      </div>
      ...
      >
        <div className="relative group">
          {/* Neon Border Glow */}
          <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-[2.5rem] blur opacity-15 group-hover:opacity-30 transition duration-1000"></div>
          ...
          <div className="relative bg-[#0b0f19]/60 border border-white/5 backdrop-blur-3xl rounded-[2.5rem] shadow-2xl p-10 sm:p-12">
            <div className="text-center mb-10">
              ...
              >
                <LogIn className="w-8 h-8 text-black font-extrabold" />
              </motion.div>
              <h2 className="text-3xl font-black text-white tracking-tight mb-2">
                Hello Again
              </h2>
              <p className="text-xs text-slate-400 font-medium tracking-wide">
                Step into your Next-Gen AI workspace
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="relative w-full overflow-hidden group py-4 px-4 rounded-2xl bg-emerald-500 text-black font-extrabold text-xs tracking-wider transition-all hover:bg-emerald-400 disabled:opacity-50 shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/20"
              >
            ...
            <p className="mt-10 text-center text-xs text-slate-500 font-medium">
              New here?{' '}
              <Link href="/signup" className="font-extrabold text-white hover:text-emerald-400 underline-offset-4 hover:underline transition-all">
                Create an account
              </Link>
            </p>
          </div>
