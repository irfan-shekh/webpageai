  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 rounded-2xl border border-white/5 bg-[#06080d]/40 backdrop-blur-xl space-y-5">
          <h4 className="text-sm font-bold text-white border-b border-white/5 pb-2">Connected Accounts</h4>
          <p className="text-[11px] text-slate-400 leading-relaxed font-sans">
            Link social accounts to log in to WebpageAI seamlessly.
          </p>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3.5 rounded-xl border border-white/5 bg-[#030712]/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 font-sans">For secure one-click sign in</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl border border-white/5 bg-[#030712]/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-bold text-white">GitHub Account</p>
                  <p className="text-[10px] text-slate-500 font-sans">For importing code repositories and logging in</p>
                </div>
              </div>
              <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-lg">
                Available
